...
describe("compareTwoStrings", function () {
  ...
  it("returns the correct value for different inputs:", function () {
    const testData = [
      ...
      { first: "", second: "a", expected: 0 },
      {
        first: "apple event",
        second: "apple    event",
        expected: 0.8695652173913043,
      },
      { first: "iphone", second: "iphone x", expected: 0.8333333333333334 },
    ];
  ...
  it("string with different spaces are not identifical", function () {
    var score = compareTwoStrings(
...
describe("findBestMatch", function () {
  ...
  it("assigns a similarity rating to each string passed in the array", function () {
    var matches = findBestMatch("healed", [
      "mailed",
      "edward",
      "sealed",
      "theatre",
